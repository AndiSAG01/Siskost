...
<head>
    ...
    <title>Laporan Sewa Kost Bulanan</title>
...
<body onload="window.print()">
    <div class="container">
        <h2 class="uppercase text-center font-semibold">Laporan Sewa Kost Bulanan</h2>
    </div>
            ...
            <tbody>
                @foreach ($sewa as $item)
                    <tr>
                        ...
                        <td class="p-4 border-b border-blue-gray-50">Rp.{{ number_format($item->kost->price_month, 2) }}</td>
                        <td class="p-4 border-b border-blue-gray-50">{{ $item->star_date }}</td>
                        <td class="p-4 border-b border-blue-gray-50">{{ $item->end_date }}</td>
                        <td class="p-4 border-b border-blue-gray-50">{{ $item->TotalJumlahSewa }} Bulan</td>
