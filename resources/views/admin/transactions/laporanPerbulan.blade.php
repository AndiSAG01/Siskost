<x-admin-layouts>
    <x-slot:breadcrumbs>
        <x-breadcrumbs active="Transaction / Laporan Perbulan" />
    </x-slot:breadcrumbs>
                ...
                <li class="z-30 flex-auto text-center">
                    <a href="{{ route('pageslaporanbulanan') }}"
                       ...
                       <i class="fas fa-house-user"></i>
                        <span class="ml-1">Laporan Kost Bulanan</span>
                    </a>
                </li>
                <li class="z-30 flex-auto text-center">
                    <a href="{{ route('pageslaporantahunan') }}"
                        ...
                        <span class="ml-1 text-black">Laporan Kost Tahunan</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="container py-4">
        <a href="{{ route('print.bulanan') }}" class="btn btn-secondary rounded mb-4">Print</a>
        <div
