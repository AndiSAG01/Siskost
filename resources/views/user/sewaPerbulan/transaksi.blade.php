    ...
    <div class="section">
        <div class="container">
            <div class="container py-20">
                <div class="w-2/3" style="margin-left: 200px">
                        ...
                        <ul class="relative flex flex-wrap p-1 list-none rounded-xl bg-blue-gray-50/60" data-tabs="tabs"
                            ...
                            <li class="z-30 flex-auto text-center">
                                <a href="{{ route('transaksi') }}"
                                    ...
                                    data-tab-target="" role="tab" aria-selected="{{ request()->routeIs('transaksi') ? 'true' : 'false' }}">
                            ...
                            <li class="z-30 flex-auto text-center">
                                <a href="{{ route('transaksi_tahunan') }}"
                                    ...
                                    data-tab-target="" role="tab" aria-selected="{{ request()->routeIs('transaksi_tahunan') ? 'true' : 'false' }}">
                                    <i class="fas fa-house-user"></i>
                            ...
                            <tr class="even:bg-blue-gray-50/50 uppercase">
                                ...
                                <td class="p-4">
                                    <p
                                        ...
                                        @elseif ($daysRemaining <= 4 && $daysRemaining >= 0)
                                            <a href="{{ route('PageSewaUpdate', $item->id) }}">
                                                <button
                                            ...
                                            <form action="{{ route('endTransaction', $item->id) }}" method="POST">
                                                @csrf
                                                @method('put')
                                                <button
                                        ...
                                        @else
                                            <a href="{{ route('transaksi.Pembayaran', $item->id) }}">
                                                <button
                                                    class="mt-2 select-none rounded-lg bg-yellow-700 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-black shadow-md shadow-blue-500/20 transition-all hover:shadow-black focus:opacity-5 focus:shadow-none active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                                                    Pembayaran
                                                </button>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="deleteModalLabel">Apakah Anda Ingin
                                                                Menghapusnya</h5>
